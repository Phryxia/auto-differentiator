...
describe('nodes.sinh', () => {
  test('evaluate', () => {
    ...
    expect(sinh.evaluate({ x: 1 })).toBe(Math.sinh(1))
  })
})
...
describe('nodes.cosh', () => {
  test('evaluate', () => {
    ...
    expect(cosh.evaluate({ x: 1 })).toBe(Math.cosh(1))
  })
})
...
describe('nodes.tanh', () => {
  test('evaluate', () => {
    ...
    expect(tanh.evaluate({ x: 1 })).toBe(Math.tanh(1))
  })
})
...
describe('nodes.csch', () => {
  test('evaluate', () => {
    ...
    expect(csch.evaluate({ x: 1 })).toBe(1 / Math.sinh(1))
  })
})
...
describe('nodes.sech', () => {
  test('evaluate', () => {
    ...
    expect(sech.evaluate({ x: 1 })).toBe(1 / Math.cosh(1))
  })
})
...
describe('nodes.coth', () => {
  test('evaluate', () => {
    ...
    expect(coth.evaluate({ x: 1 })).toBe(1 / Math.tanh(1))
  })
})
